# 1.)  print index of string list
fruits = ['apple', 'banana', 'cherry']
x = fruits.index("cherry")
print(x)
    #  It will print the index where word is present

# 2.)  print index of int list 
numbers = [4, 55, 64, 32, 16, 32]
x = numbers.index(32)
print(numbers)
     #  It will print the index where number is present
     
# 3.)  Print element with index
print(numbers[3])
print(numbers[5])
